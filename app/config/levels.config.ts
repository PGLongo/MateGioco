...
export const LEVELS: LevelConfig[] = [
  ...
  { id: 'mix-1', worldId: 'mix', nameKey: 'levels.mix1', operation: '+', minNumber: 1, maxNumber: 100, starsToUnlock: 8, unlockReq: 'sub-4', mixedOperations: ['+', '-'] },

  // Mondo 4: Il Prato delle Tabelline. Si apre dopo la Grande Sfida: moltiplicare presuppone
  // saper sommare in colonna
  { id: 'mul-1', worldId: 'mul', nameKey: 'levels.mul1', operation: '*', minNumber: 1, maxNumber: 20, starsToUnlock: 8, unlockReq: 'mix-1' },
  { id: 'mul-2', worldId: 'mul', nameKey: 'levels.mul2', operation: '*', minNumber: 1, maxNumber: 50, starsToUnlock: 8, unlockReq: 'mul-1' },
  { id: 'mul-3', worldId: 'mul', nameKey: 'levels.mul3', operation: '*', minNumber: 1, maxNumber: 100, starsToUnlock: 8, unlockReq: 'mul-2' },
  ...
  { id: 'div-1', worldId: 'div', nameKey: 'levels.div1', operation: '/', minNumber: 1, maxNumber: 20, starsToUnlock: 8, unlockReq: 'mul-1' },
  { id: 'div-2', worldId: 'div', nameKey: 'levels.div2', operation: '/', minNumber: 1, maxNumber: 50, starsToUnlock: 8, unlockReq: 'div-1' },
  { id: 'div-3', worldId: 'div', nameKey: 'levels.div3', operation: '/', minNumber: 1, maxNumber: 100, starsToUnlock: 8, unlockReq: 'div-2' },

  // La Sfida Suprema: tutte e quattro le operazioni, ultimo livello del percorso
  { id: 'mix-2', worldId: 'mix', nameKey: 'levels.mix2', operation: '+', minNumber: 1, maxNumber: 100, starsToUnlock: 8, unlockReq: 'div-3', mixedOperations: ['+', '-', '*', '/'] }
]
